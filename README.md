...
-   The application connects to the external API, fetches and parses JSON
-   Search functionality implemented
-   Bonus: Use the movie backdrop image creatively
-   Bonus: Use the movie slug for routing
